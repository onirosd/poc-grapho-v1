...
public interface DbcDao {
    ...
    Map<String, Object> findDbcDceDcpByCicAndPersonIdAndCustomerType(String cic, String personId , String customerType, String fullName, String fatherName, String motherName, String birthDate , String birthPlace);
